...
public class Wine {
	...
	public Wine(int price,WineVariety wineVariety ,WineType wineType,String labelName,String grape, String region, String country, String maker, String year,ArrayList<Note> note) {
