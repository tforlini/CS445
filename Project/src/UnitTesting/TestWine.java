...
import WineClub.WineType;
import WineClub.WineVariety;

public class TestWine {

	private final ByteArrayOutputStream outContent = new ByteArrayOutputStream();
	private final ByteArrayOutputStream errContent = new ByteArrayOutputStream();
	private final Wine wine = new Wine(15, WineVariety.WHITE,WineType.SPARKLING,"Dom Perignon","","Champagne","France","Moet & Chandon","2012"); 
