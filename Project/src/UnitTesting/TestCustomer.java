...
public class TestCustomer {
	...
	private final Customer customer = new Customer(1,"Tony","Forlini",new Address("3000 N Sheridan Rd","Chicago","IL","60657"),new Date(),"M","tforlini@hawk.iit.edu","3124783001","Tony Forlini","tforlini",new Date(),"password",null,1);
