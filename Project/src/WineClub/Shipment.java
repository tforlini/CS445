...
public class Shipment {
	...
	public Shipment(int id,int price,int numberOfMonthlySelections, MonthlySelection monthlySelection,String type,Date subscriptionDate,String customerEmail,String note,Date forecastedDeliveryDate,String forecastedDeliveryTime, int deliveryCharge) {
		this.id=id;
		this.price=price;
